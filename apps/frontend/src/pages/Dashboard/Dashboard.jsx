...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (rol === 'ADMIN') {
      ...
      // Para usuario de farmacia, usamos su farmacia activa y cargamos directamente sus datos
  ...
  function prepararDatosVentasDevoluciones() {
    try {
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-6">
        ...
        {/* Selector de farmacia solo para administradores */}
        {isAdmin && farmacias.length > 0 && (
        ...
        {/* Para usuarios de farmacia, mostrar el nombre de su farmacia */}
        {!isAdmin && farmaciaSeleccionada && (
          <div className="px-4 py-2 bg-indigo-50 rounded-md">
